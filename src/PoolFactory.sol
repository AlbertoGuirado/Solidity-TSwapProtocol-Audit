...
contract PoolFactory { 
    ...
    //@ audit-info [x] this error is not used!
    error PoolFactory__PoolDoesNotExist(address tokenAddress);

    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    mapping(address token => address pool) private s_pools; // e probably poolToken
    mapping(address pool => address token) private s_tokens; // e mapng back
    ...
    constructor(address wethToken) {
        //@ audit-info [X] lacking zero address. Check if wethToken is 0x00..0
    ...
    function createPool(address tokenAddress) external returns (address) {
        ...
        // e "tsUSDC" 
        //@ audit-info [X] should be .symbol not .name
