...
contract TSwapPool is ERC20 {
    ...
    //@ audit-info [X] 3 events should be indexed if there are more than 3 parameters
    event Swap(
    ...
    constructor(
        ...
        //@ audit-info [X] check address zero
    ...
    function deposit(
        ...
        uint256 minimumLiquidityTokensToMint,
        uint256 maximumPoolTokensToDeposit,
        //@ audit [X] high! deadline not being used
        //if someone sets a deadline, let's say, next blocl
        // they could still deposit
        // IMPACT -> a user who expect a deposit to fail, will go through. Severe disruption of functionality
        // Likelihood: HIGH ALWAYS thecase
        uint64 deadline
    )
        external
        ...
        returns (uint256 liquidityTokensToMint)
    {
        if (wethToDeposit < MINIMUM_WETH_LIQUIDITY) {
            //@ audit-info MINIMUM_WETH_LIQUIDITY is a const and therefore not requiret to be emmited
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            //@ audit-info [GAS] [X] don't used the var -> gas waste
            ...
            // deposit 10ETH
            // getPoolToke -> if returns $1.000.000M -> REVERT
            ...
            // The previous function do an external call
            // Now updating a variable
            // POSSIBLE REENTRANCY
            //@ audit-info [X] Should be before the _addLiquidityMintAndTransfer call
    ...
    function _addLiquidityMintAndTransfer(
        ...
        // @ audit low [X] -> this is backwards! Should be wethToDeposit, poolTokenToDeposit
    ...
    function withdraw(
        ...
        //  protege contra la ejecución tardía de la transacción, 
        //  evitando cambios en el mercado que podrían ser desfavorables.
        uint64 deadline
    )
        external
        ...
        revertIfZero(minPoolTokensToWithdraw)
    {
        ...
        // NOT AN EXTERNAL CALL -> Come from ERC20
    ...
    {
        //@ audit-info [X] magic numbers -> should be constant
        // 997 / 10000 -> 0.0997
        // 91.3% fee???
        // @ audit HIGH [X]-> The swap fee is too big
        // IMPACT HIGH -> Users are charge to much for fee
...
//@ audit-info natspec
        ...
        returns (uint256 inputAmount)
    {
        ...
        // MEV atack <need to learn>
        //IMPACT HIGH --> a user may get a way worse swap
        //LILELIHOOD Medium/High
    ...
    function sellPoolTokens(
        ...
        // pool token -> input
        // @ audit [X] WRONG order
        // SwapExactInput(minWethToRceive)
        // IMPACT
        // LIKELIHOOD
        return
            swapExactOutput(
    ...
    function _swap(
        ...
        //@ audit [X] brecks protocol invariant !!!!
        swap_count++;
